<%@page import="entity.Employee, entity.Section, java.util.List"%><%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%
    ...
    <div class="main_wrapper">
        ...
        <form action="RegistEmployee" method="post" onsubmit="return chk()">
            <div class="comment_show_all" id="comment_show_all">
                文字の入力、もしくは氏・名は16文字以下、<br>氏かな・名かなは24文字以下で入力
            </div>
